  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        'brand-primary': tokens.Semantic.color.main['brand-primary'].$value.$value,
        'brand-secondary': tokens.Semantic.color.main['brand-secondary'].$value.$value,
        'brand-tertiary': tokens.Semantic.color.main['brand-tertiary'].$value.$value,

        'bg-body': tokens.Semantic.color.background['bg-body'].$value.$value,
        'bg-card': tokens.Semantic.color.background['bg-card'].$value.$value,
        'bg-primary-button': tokens.Semantic.color.background['bg-primary-button'].$value.$value,
        'bg-footer': tokens.Semantic.color.background['bg-footer'].$value.$value,
        'bg-header': tokens.Semantic.color.background['bg-header'].$value.$value,
        'bg-drop-down': tokens.Semantic.color.background['bg-drop-down'].$value.$value,

        'text-primary': tokens.Semantic.color.text['text-primary'].$value.$value,
        'text-secondary': tokens.Semantic.color.text['text-secondary'].$value.$value,
        'text-tertiary': tokens.Semantic.color.text['text-tertiary'].$value.$value,
        'text-title': tokens.Semantic.color.text['text-title'].$value.$value,
        'text-paragraph': tokens.Semantic.color.text['text-paragraph'].$value.$value,
        'text-contrast': tokens.Semantic.color.text['text-contrast'].$value.$value,

        'line-button-primary': tokens.Semantic.color.line['button-primary'].$value.$value.$value,
        'line-button-secondary': tokens.Semantic.color.line['button-secondary'].$value.$value.$value,
        'line-button-tertiary': tokens.Semantic.color.line['button-tertiary'].$value.$value.$value,
        'line-card': tokens.Semantic.color.line['card'].$value.$value,
        'line-drop-down': tokens.Semantic.color.line['drop-down'].$value.$value,
        'line-footer': tokens.Semantic.color.line['footer'].$value.$value,
        'line-header': tokens.Semantic.color.line['header'].$value.$value,
      },
      ...
      spacing: {
        ...
        'gap-xs': `${tokens.Semantic.gap['gap-xs'].$value.$value}px`,
        'gap-sm': `${tokens.Semantic.gap['gap-sm'].$value.$value}px`,
        'gap-md': `${tokens.Semantic.gap['gap-md'].$value.$value}px`,
        'gap-lg': `${tokens.Semantic.gap['gap-lg'].$value.$value}px`,
        'gap-xl': `${tokens.Semantic.gap['gap-xl'].$value.$value}px`,
        'button-base-y': `${tokens.Semantic.padding['button-base-x'].$value.$value}px`,
        'button-base-x': `${tokens.Semantic.padding['button-base-y'].$value.$value}px`,
        'button-lg-y': `${tokens.Semantic.padding['button-lg-x'].$value.$value}px`,
        'button-lg-x': `${tokens.Semantic.padding['button-lg-y'].$value.$value}px`,
        'button-xl-y': `${tokens.Semantic.padding['button-xl-x'].$value.$value}px`,
        'button-xl-x': `${tokens.Semantic.padding['button-xl-y'].$value.$value}px`,
        'link-button': `${tokens.Semantic.padding['link button'].$value.$value}px`,
        'card': `${tokens.Semantic.padding.card.$value.$value}px`,
        'drop-down': `${tokens.Semantic.padding['drop-down'].$value.$value}px`,
        'footer': `${tokens.Semantic.padding.footer.$value.$value}px`,
        'header': `${tokens.Semantic.padding.header.$value.$value}px`,
      },
      ...
      borderRadius: {
        ...
        'card': `${tokens.Semantic.radius.card.$value.$value}px`,
        'button': `${tokens.Semantic.radius.button.$value.$value}px`,
        'drop-down': `${tokens.Semantic.radius.dropdown.$value.$value}px`,
      },
      ...
      fontSize: {
        ...
        'h1': `${tokens.Semantic['font-sizes'].h1.$value.$value}px`,
        'h2': `${tokens.Semantic['font-sizes'].h2.$value.$value}px`,
        'h3': `${tokens.Semantic['font-sizes'].h3.$value.$value}px`,
        'h4': `${tokens.Semantic['font-sizes'].h4.$value.$value}px`,
        'h5': `${tokens.Semantic['font-sizes'].h5.$value.$value}px`,
        'h6': `${tokens.Semantic['font-sizes'].h6.$value.$value}px`,
        'p': `${tokens.Semantic['font-sizes'].p.$value.$value}px`,
        'span': `${tokens.Semantic['font-sizes'].span.$value.$value}px`,
        'label': `${tokens.Semantic['font-sizes'].label.$value.$value}px`,
      },
