  ...
  theme: {
    ...
    extend: {
      ...
      spacing: {
        ...
        'button-base-x': `${tokens.Semantic.padding['button-base-x'].$value.$value}px`,
        'button-base-y': `${tokens.Semantic.padding['button-base-y'].$value.$value}px`,
        'button-lg-x': `${tokens.Semantic.padding['button-lg-x'].$value.$value}px`,
        'button-lg-y': `${tokens.Semantic.padding['button-lg-y'].$value.$value}px`,
        'button-xl-x': `${tokens.Semantic.padding['button-xl-x'].$value.$value}px`,
        'button-xl-y': `${tokens.Semantic.padding['button-xl-y'].$value.$value}px`,
