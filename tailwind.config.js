  ...
  theme: {
    ...
    extend: {
      ...
      spacing: {
        ...
        'spacing-22': `${tokens.Primitives.typography.sizes['font-size-22'].$value}px`,
        'spacing-23': `${tokens.Primitives.typography.sizes['font-size-23'].$value}px`,
        'spacing-24': `${tokens.Primitives.typography.sizes['font-size-24'].$value}px`,
        'spacing-25': `${tokens.Primitives.typography.sizes['font-size-25'].$value}px`,

        // Semánticos - Gaps y Padding
        'gap-xs': `${tokens.Semantic.spacing.gap['gap-xs'].$value}px`,
        'gap-sm': `${tokens.Semantic.spacing.gap['gap-sm'].$value}px`,
        'gap-md': `${tokens.Semantic.spacing.gap['gap-md'].$value}px`,
        'gap-lg': `${tokens.Semantic.spacing.gap['gap-lg'].$value}px`,
        'gap-xl': `${tokens.Semantic.spacing.gap['gap-xl'].$value}px`,
        'button-base-x': `${tokens.Semantic.spacing.padding['button-base-x'].$value}px`,
        'button-base-y': `${tokens.Semantic.spacing.padding['button-base-y'].$value}px`,
        'button-lg-x': `${tokens.Semantic.spacing.padding['button-lg-x'].$value}px`,
        'button-lg-y': `${tokens.Semantic.spacing.padding['button-lg-y'].$value}px`,
        'button-xl-x': `${tokens.Semantic.spacing.padding['button-xl-x'].$value}px`,
        'button-xl-y': `${tokens.Semantic.spacing.padding['button-xl-y'].$value}px`,
        'link-button': `${tokens.Semantic.spacing.padding['link-button'].$value}px`,
        'card': `${tokens.Semantic.spacing.padding['card'].$value}px`,
        'drop-down': `${tokens.Semantic.spacing.padding['drop-down'].$value}px`,
        'footer': `${tokens.Semantic.spacing.padding['footer'].$value}px`,
        'header': `${tokens.Semantic.spacing.padding['header'].$value}px`,
      },
